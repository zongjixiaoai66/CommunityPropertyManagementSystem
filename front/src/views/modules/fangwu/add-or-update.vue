    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="楼栋" prop="fangwuLoudong">
                       <el-input v-model="ruleForm.fangwuLoudong"
                                 placeholder="楼栋" clearable  :readonly="ro.fangwuLoudong"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="楼栋" prop="fangwuLoudong">
                           <el-input v-model="ruleForm.fangwuLoudong"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="单元" prop="fangwuDanyuan">
                       <el-input v-model="ruleForm.fangwuDanyuan"
                                 placeholder="单元" clearable  :readonly="ro.fangwuDanyuan"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="单元" prop="fangwuDanyuan">
                           <el-input v-model="ruleForm.fangwuDanyuan"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房号" prop="fangwuFanghao">
                       <el-input v-model="ruleForm.fangwuFanghao"
                                 placeholder="房号" clearable  :readonly="ro.fangwuFanghao"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="房号" prop="fangwuFanghao">
                           <el-input v-model="ruleForm.fangwuFanghao"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="房产类型" prop="fangwuTypes">
                        <el-select v-model="ruleForm.fangwuTypes" :disabled="ro.fangwuTypes" placeholder="请选择房产类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="房产类型" prop="fangwuValue">
                        <el-input v-model="ruleForm.fangwuValue"
                            placeholder="房产类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="房屋备注" prop="fangwuContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fangwuContent" label="房屋备注" prop="fangwuContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   fangwuContent: [
                              { required: true, message: '房屋备注不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
